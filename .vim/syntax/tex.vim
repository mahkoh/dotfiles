...
"syn cluster texMathZones add=texThmX
"syn region texThmX matchgroup=texMyRegions start='\\begin\s*{\s*thm\s*}' end='\\end\s*{\s*thm\s*}' keepend contains=@texMathZoneGroup
"syn cluster texMathZones add=texDefiX
"syn region texDefiX matchgroup=texMyRegions start='\\begin\s*{\s*defi\s*}' end='\\end\s*{\s*defi\s*}' keepend
 ...
 if has("conceal") && &enc == 'utf-8' && s:tex_conceal =~ 'd'
  ...
  syn region texMathZoneY	matchgroup=texMathDelimX start="\$\$" 			matchgroup=texMathDelimX end="\$\$" end="%stopzone\>"	concealends keepend		contains=@texMathZoneGroup
 else
  syn region texMathZoneV	matchgroup=texMathDelimX start="\\("			matchgroup=texMathDelimX end="\\)\|%stopzone\>"	keepend contains=@texMathZoneGroup
  syn region texMathZoneW	matchgroup=texMathDelimX start="\\\["			matchgroup=texMathDelimX end="\\]\|%stopzone\>"	keepend contains=@texMathZoneGroup
  syn region texMathZoneX	matchgroup=Delimiter start="\$" skip="\\\\\|\\\$"	matchgroup=Delimiter end="\$" end="%stopzone\>"	contains=@texMathZoneGroup
  syn region texMathZoneY	matchgroup=texMathDelimX start="\$\$" 			matchgroup=texMathDelimX end="\$\$" end="%stopzone\>"	keepend		contains=@texMathZoneGroup
 endif
